...
//         {
//             // Update or create in memory
//             _sessions.AddOrUpdate(riderId,
//                 _ => new RiderSession
//                 {
//                     RiderId = riderId,
//                     Latitude = latitude,
//                     Longitude = longitude,
//                     Zone = zone?.Name ?? string.Empty,
//                     Status = RiderStatus.Active
//                 },
//                 (_, session) =>
//                 {
...
//                     session.Zone = zone?.Name ?? string.Empty;
//                     return session;
//                 });
...
//         {
//             Console.WriteLine("inside get nearest " + latitude + " " + longitude);
