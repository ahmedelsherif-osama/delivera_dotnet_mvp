...
namespace Delivera.Migrations
{
    ...
    [Migration("20250903054520_AddAreaToZoneTableModel")]
    partial class AddAreaToZoneTableModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Delivera.Models.BaseUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("802f2fcf-d0e8-434e-bd09-0e976231324b"),
                            ApprovedAt = new DateTime(2025, 9, 3, 5, 45, 20, 294, DateTimeKind.Utc).AddTicks(8532),
                            CreatedAt = new DateTime(2025, 9, 3, 5, 45, 20, 294, DateTimeKind.Utc).AddTicks(8536),
