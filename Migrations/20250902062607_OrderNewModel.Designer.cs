...
namespace Delivera.Migrations
{
    ...
    [Migration("20250902062607_OrderNewModel")]
    partial class OrderNewModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Delivera.Models.BaseUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5802bf30-604c-4578-ba84-193669b0de09"),
                            ApprovedAt = new DateTime(2025, 9, 2, 6, 26, 6, 981, DateTimeKind.Utc).AddTicks(7271),
                            CreatedAt = new DateTime(2025, 9, 2, 6, 26, 6, 981, DateTimeKind.Utc).AddTicks(7275),
            ...
            modelBuilder.Entity("Delivera.Models.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Delivera.Models.Order", b =>
                {
                    b.HasOne("Delivera.Models.Location", "DropOffLocation")
                        .WithMany()
                        .HasForeignKey("DropOffLocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Delivera.Models.Location", "PickUpLocation")
                        .WithMany()
